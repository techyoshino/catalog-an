...
<div id="container">
			...
			<div class="header__content">
				...
				<div class="navbar-right">
					...
					<div class="auth-button-container">
						<div class="auth-button mr10"><a href="https://auth.videfit.com/oauth/authorize?client_id=9744a00e-cf82-4dbe-9e91-f6c1a54b6e7d&redirect_uri=https://kikaicatalog.com/callback&response_type=code&scope=%2A&state=Q6eFbHuemurkjiTyEf0KIVh8jMPF3dmaCkN55Lcb&prompt=1">ログイン</a></div> 
						<div class="auth-button mr20">新規登録</div>
					</div>
	...
	<div id="contents">
		...
		<div class="breadcrumbs-cont">
			<div class="container items-baseline">
